...
using Codeflix.Catalog.Api.Models.CastMembers;
...
using Codeflix.Catalog.Application.UseCases.CastMembers.DeleteCastMember;
using Codeflix.Catalog.Application.UseCases.CastMembers.GetCastMember;
using Codeflix.Catalog.Application.UseCases.CastMembers.ListCastMembers;
using Codeflix.Catalog.Application.UseCases.CastMembers.UpdateCastMember;

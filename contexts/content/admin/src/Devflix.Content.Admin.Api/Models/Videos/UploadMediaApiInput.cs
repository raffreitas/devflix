using Devflix.Content.Admin.Api.Extensions;
...
public sealed class UploadMediaApiInput
{
    ...
    [FromForm(Name = "media_file")] public IFormFile Media { get; set; }

    public UploadMediasInput ToUploadMediasInput(Guid id, string type) => type.ToLower() switch
    {

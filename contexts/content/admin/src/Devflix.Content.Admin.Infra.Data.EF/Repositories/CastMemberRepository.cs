...
namespace Devflix.Content.Admin.Infra.Data.EF.Repositories;

public class CastMemberRepository(DevflixContentAdminDbContext context) : ICastMemberRepository
{

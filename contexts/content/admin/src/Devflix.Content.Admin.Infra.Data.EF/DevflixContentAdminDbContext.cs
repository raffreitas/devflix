using Devflix.Content.Admin.Infra.Data.EF.Configurations;
...
public class DevflixContentAdminDbContext(DbContextOptions<DevflixContentAdminDbContext> options)
    : DbContext(options)
{

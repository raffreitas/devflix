...
namespace FC.Codeflix.Catalog.Infra.Data.EF.Migrations
{
    ...
    [Migration("20250911111921_CreateTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FC.Codeflix.Catalog.Domain.Entities.CastMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FC.Codeflix.Catalog.Domain.Entities.Genre", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("FC.Codeflix.Catalog.Domain.Entities.Video", b =>
                {
                    ...
                    b.OwnsOne("FC.Codeflix.Catalog.Domain.ValueObjects.Image", "Thumb", b1 =>
                        {
                            b1.Property<Guid>("VideoId")
                                .HasColumnType("char(36)");
                    ...
                    b.OwnsOne("FC.Codeflix.Catalog.Domain.ValueObjects.Image", "ThumbHalf", b1 =>
                        {
                            b1.Property<Guid>("VideoId")
                                .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("FC.Codeflix.Catalog.Infra.Data.EF.Models.GenresCategories", b =>
                {
                    b.HasOne("FC.Codeflix.Catalog.Domain.Entities.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FC.Codeflix.Catalog.Domain.Entities.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("FC.Codeflix.Catalog.Infra.Data.EF.Models.VideosCastMembers", b =>
                {
                    b.HasOne("FC.Codeflix.Catalog.Domain.Entities.CastMember", "CastMember")
                        .WithMany()
                        .HasForeignKey("CastMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FC.Codeflix.Catalog.Domain.Entities.Video", "Video")
                        .WithMany()
                        .HasForeignKey("VideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

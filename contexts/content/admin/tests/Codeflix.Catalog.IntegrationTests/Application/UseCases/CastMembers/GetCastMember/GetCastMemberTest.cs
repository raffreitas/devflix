...
using UseCase = Codeflix.Catalog.Application.UseCases.CastMembers.GetCastMember;

namespace Codeflix.Catalog.IntegrationTests.Application.UseCases.CastMembers.GetCastMember;

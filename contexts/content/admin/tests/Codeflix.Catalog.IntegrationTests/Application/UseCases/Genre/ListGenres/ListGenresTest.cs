...
public class ListGenresTest(ListGenresTestFixture fixture)
{
    ...
    {
        List<Codeflix.Catalog.Domain.Entities.Genre> exampleGenres = fixture.GetExampleListGenres();
        ...
        {
            Codeflix.Catalog.Domain.Entities.Genre? exampleItem =
    ...
    {
        List<Codeflix.Catalog.Domain.Entities.Genre> exampleGenres = fixture.GetExampleListGenres(quantityToGenerate);
        List<Category> exampleCategories = fixture.GetExampleCategoriesList();
        Random random = new Random();
        exampleGenres.ForEach(genre =>
        {

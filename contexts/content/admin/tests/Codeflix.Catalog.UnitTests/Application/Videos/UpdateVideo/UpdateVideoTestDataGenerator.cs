...
using Codeflix.Catalog.Application.UseCases.Videos.UpdateVideo;
using Codeflix.Catalog.UnitTests.Application.Videos.CreateVideo;

namespace Codeflix.Catalog.UnitTests.Application.Videos.UpdateVideo;

internal sealed class UpdateVideoTestDataGenerator : IEnumerable<object[]>
{

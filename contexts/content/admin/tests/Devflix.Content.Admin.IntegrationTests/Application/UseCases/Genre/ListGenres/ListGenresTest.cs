...
namespace Devflix.Content.Admin.IntegrationTests.Application.UseCases.Genre.ListGenres;
...
public class ListGenresTest(ListGenresTestFixture fixture)
{
    ...
    {
        List<Devflix.Content.Admin.Domain.Entities.Genre> exampleGenres = fixture.GetExampleListGenres();
        DevflixContentAdminDbContext arrangeDbContext = fixture.CreateDbContext();
        await arrangeDbContext.AddRangeAsync(exampleGenres);
        await arrangeDbContext.SaveChangesAsync();
        DevflixContentAdminDbContext actDbContext = fixture.CreateDbContext(true);
        ...
        {
            Devflix.Content.Admin.Domain.Entities.Genre? exampleItem =
    ...
    {
        DevflixContentAdminDbContext actDbContext = fixture.CreateDbContext();
        ListGenresUseCase useCase = new ListGenresUseCase(
            new GenreRepository(actDbContext),
            new CategoryRepository(actDbContext)
        );
    ...
    public async Task ListGenresVerifyRelations()
    {
        ...
        exampleGenres.ForEach(genre =>
        {
            ...
            for (int i = 0; i < relationsCount; i++)
            {
                ...
                Category selected = exampleCategories[selectedCategoryIndex];
    ...
    {
        List<Devflix.Content.Admin.Domain.Entities.Genre> exampleGenres = fixture.GetExampleListGenres(quantityToGenerate);
        List<Category> exampleCategories = fixture.GetExampleCategoriesList();
        Random random = new Random();
        exampleGenres.ForEach(genre =>
        {

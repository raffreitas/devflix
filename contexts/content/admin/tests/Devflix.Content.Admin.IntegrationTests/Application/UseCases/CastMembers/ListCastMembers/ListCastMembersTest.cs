...
using UseCase = Devflix.Content.Admin.Application.UseCases.CastMembers.ListCastMembers;

namespace Devflix.Content.Admin.IntegrationTests.Application.UseCases.CastMembers.ListCastMembers;

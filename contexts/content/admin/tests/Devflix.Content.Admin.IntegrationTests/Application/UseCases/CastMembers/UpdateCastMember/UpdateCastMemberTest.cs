...
using UseCase = Devflix.Content.Admin.Application.UseCases.CastMembers.UpdateCastMember;

namespace Devflix.Content.Admin.IntegrationTests.Application.UseCases.CastMembers.UpdateCastMember;

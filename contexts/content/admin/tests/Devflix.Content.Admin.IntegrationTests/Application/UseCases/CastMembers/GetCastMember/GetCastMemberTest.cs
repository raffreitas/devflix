...
using UseCase = Devflix.Content.Admin.Application.UseCases.CastMembers.GetCastMember;

namespace Devflix.Content.Admin.IntegrationTests.Application.UseCases.CastMembers.GetCastMember;

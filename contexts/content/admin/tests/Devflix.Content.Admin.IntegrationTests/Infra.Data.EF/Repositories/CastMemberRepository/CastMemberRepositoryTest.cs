...
namespace Devflix.Content.Admin.IntegrationTests.Infra.Data.EF.Repositories.CastMemberRepository;
...
public class CastMemberRepositoryTest(CastMemberRepositoryTestFixture fixture)
{
    ...
    {
        var castMemberExampleList = fixture.GetExampleCastMembersList(5);
    ...
    {
        var exampleList = fixture.GetExampleCastMembersList(quantityToGenerate);
        var arrangeDbContext = fixture.CreateDbContext();
        await arrangeDbContext.AddRangeAsync(exampleList);
        await arrangeDbContext.SaveChangesAsync();
        var castMembersRepository = new Repository.CastMemberRepository(fixture.CreateDbContext(true));
    ...
    )
    {
        ...
        var exampleList = fixture.GetExampleCastMembersListByNames(namesToGenerate);
        var arrangeDbContext = fixture.CreateDbContext();
        await arrangeDbContext.AddRangeAsync(exampleList);
        await arrangeDbContext.SaveChangesAsync();
        var castMembersRepository = new Repository.CastMemberRepository(fixture.CreateDbContext(true));
    ...
    {
        var exampleList = fixture.GetExampleCastMembersList(5);
        var arrangeDbContext = fixture.CreateDbContext();
        await arrangeDbContext.AddRangeAsync(exampleList);
        await arrangeDbContext.SaveChangesAsync();
        var castMembersRepository = new Repository.CastMemberRepository(fixture.CreateDbContext(true));

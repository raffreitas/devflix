...
using Devflix.Content.Admin.EndToEndTests.Api.CastMembers.Common;
using Devflix.Content.Admin.EndToEndTests.Models;
...
namespace Devflix.Content.Admin.EndToEndTests.Api.CastMembers.ListCastMembers;

[Collection(nameof(CastMemberApiBaseFixture))]
public class ListCastMembersApiTest(CastMemberApiBaseFixture fixture, ITestOutputHelper output) : IDisposable
{
    ...
    )
    {
        ...
        var (response, output1) =
            await fixture.ApiClient.Get<TestApiResponseList<CastMemberModelOutput>>(
                "cast_members",
                new { Sort = orderBy, Dir = order }
            );
        ...
        output1.Data!.Should().HaveCount(examples.Count);

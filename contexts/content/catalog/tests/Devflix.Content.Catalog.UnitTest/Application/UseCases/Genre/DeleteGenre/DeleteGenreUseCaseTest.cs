...
using Devflix.Content.Catalog.Application.UseCases.Genres.DeleteGenre;

using NSubstitute;

namespace Devflix.Content.Catalog.UnitTests.Application.UseCases.Genre.DeleteGenre;

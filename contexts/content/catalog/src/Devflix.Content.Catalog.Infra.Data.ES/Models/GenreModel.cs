...
namespace Devflix.Content.Catalog.Infra.Data.ES.Models;
...
public sealed record GenreModel
{
    ...
    public static GenreModel FromEntity(global::Devflix.Content.Catalog.Domain.Entities.Genre entity) => new()
    {
        Id = entity.Id,
        Name = entity.Name,

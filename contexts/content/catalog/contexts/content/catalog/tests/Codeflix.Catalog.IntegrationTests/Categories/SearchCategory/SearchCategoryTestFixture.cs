using Codeflix.Catalog.IntegrationTests.Categories.Common;

using Codeflix.Catalog.Domain.Repositories.DTOs;
using Codeflix.Catalog.Infra.Data.ES.Models;

namespace Codeflix.Catalog.IntegrationTests.Categories.SearchCategory;

public sealed class SearchCategoryTestFixture : CategoryTestFixture
{

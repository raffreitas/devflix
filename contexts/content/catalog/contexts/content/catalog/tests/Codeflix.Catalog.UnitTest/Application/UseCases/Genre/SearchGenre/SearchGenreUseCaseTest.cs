...
namespace Codeflix.Catalog.UnitTests.Application.UseCases.Genre.SearchGenre;
    ...
    : IClassFixture<SearchGenreUseCaseTestFixture>
{
    ...
    public async Task ReturnsSearchResult()
    {
        ...
        var expectedQueryResult = new SearchOutput<global::Codeflix.Catalog.Domain.Entities.Genre>(
            input.Page,
            input.PerPage,
            genres.Count,
            genres
